...
# 그룹별 배경색 정의
group_colors = {
    '원료 (온산, CMO)': 'rgba(173, 216, 230, 0.2)',  # lightblue
    '출발물질 (온산)': 'rgba(144, 238, 144, 0.2)',  # lightgreen
    '원료의약품 (온산, 익산)': 'rgba(240, 128, 128, 0.2)',  # lightcoral
    '완제의약품 (오송)': 'rgba(250, 250, 210, 0.2)'   # lightgoldenrodyellow
}
        ...
        if product_name == 'Zemimet':
            ...
            for sub_product in sub_products:
                ...
                if isinstance(sub_df, str):
                    ...
                    for spec_name, (spec_min, spec_max) in product_specs[sub_product].items():
