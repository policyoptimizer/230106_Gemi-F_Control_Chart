...
# batch_no와 insp_code를 문자열로 변환하고 공백 제거
filtered_df['batch_no'] = filtered_df['batch_no'].astype(str).str.strip()
filtered_df['insp_code'] = filtered_df['insp_code'].astype(str).str.strip()
