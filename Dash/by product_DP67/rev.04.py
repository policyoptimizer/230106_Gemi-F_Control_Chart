...
# DP67 제품에 대한 탭 생성 함수
def create_dp67_tab(dataset, window_size, sigma_level, recent_batches, trend_threshold):
...
def create_dp67_tabs(window_size, sigma_level, recent_batches, trend_threshold):
    dp67_tabs = []
    for dataset in ["DP67_AUI", "DP67_Total_Impurity"]:
        dp67_tabs.append(create_dp67_tab(dataset, window_size, sigma_level, recent_batches, trend_threshold))
    return dp67_tabs

# 앱 레이아웃 설정
app.layout = html.Div([
    html.H1('CQA DP67 AUI, Total Impurity'),
    dcc.Tabs(id="dp67-tabs", children=create_dp67_tabs(5, 1, 5, 0.02)),
    html.Div([
        html.H3('넬슨 법칙'),
