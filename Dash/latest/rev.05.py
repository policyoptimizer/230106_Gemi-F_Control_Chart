...
def create_table(df, stats):
    ...
    stats_rows = [
        html.Tr([html.Td("", style={'border': '1px solid black', 'padding': '5px', 'text-align': 'center'})] +
                [html.Td("평균", style={'border': '1px solid black', 'padding': '5px', 'text-align': 'center', 'background-color': '#f0f0f0'})] +
                [html.Td(stats['mean'][col] if col in stats['mean'] else "", style={'border': '1px solid black', 'padding': '5px', 'text-align': 'center', 'background-color': '#f0f0f0'}) for col in df.columns]),
        html.Tr([html.Td("", style={'border': '1px solid black', 'padding': '5px', 'text-align': 'center'})] +
                [html.Td("표준편차", style={'border': '1px solid black', 'padding': '5px', 'text-align': 'center', 'background-color': '#f0f0f0'})] +
                [html.Td(stats['std'][col] if col in stats['std'] else "", style={'border': '1px solid black', 'padding': '5px', 'text-align': 'center', 'background-color': '#f0f0f0'}) for col in df.columns])
    ]
